	...
	<script type="text/javascript">
		...
		$(function(){
			...
			$("#captchaImage").click(function(){//点击更换验证码
                $.post("${pageContext.request.contextPath}/Code/code",function () {
				...
				<table>
					<tbody>
						<tr>
							...
							<td>
								<input type="text"  name="name" class="easyui-textbox" data-options="iconCls:'icon-man',required:true,validType:'uname'">
							</td>
					  </tr>
					  <tr>
						  <th>
						  ...
						  <td>
							  <input type="password" name="password" class="easyui-passwordbox" data-options="required:true">
						  </td>
							</td>
					  </tr>
