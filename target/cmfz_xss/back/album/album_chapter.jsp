...
<script type="text/javascript">
    ...
    $(function () {
        $("#album").treegrid({
            ...
            columns: [[
                {field:'title',title:'名称',width:30,align:'left'},
                {field:'size',title:'章节大小',width:30,align:'center'},
                {field:'duration',title:'章节时长',width:30,align:'center'},
...
<div id="album_dialog" class="easyui-dialog" title="专辑详情" style="width:400px;height:600px;"
    ...
    <form id="album_ff" method="post">
        ...
        <div style="height: 20px;margin-top: 30px;padding-left: 20%;padding-right: 20%">
            ...
            <input id="acount" name="count" type="text"  class="easyui-validatebox"  style="width:100%;height: 100%">
        </div>
        ...
        <div style="height: 20px;margin-top: 30px;padding-left: 20%;padding-right: 20%">
            ...
            <input id="broadCast" name="broadCaet" type="text"  class="easyui-validatebox"  style="width:100%;height: 100%">
        </div>
        ...
        <div style="height: 20px;margin-top: 30px;padding-left: 20%;padding-right: 20%">
            ...
            <input id="publishDate" name="releaseDate" type="text"  class="easyui-validatebox"  style="width:100%;height: 100%">
        </div>

        <div style="height: 20px;margin-top: 30px;padding-left: 20%;padding-right: 20%">
            <label for="status">状态:</label>
            <input id="status" name="status" type="text"  class="easyui-validatebox"  style="width:100%;height: 100%" value="yes">
        </div>

        <div style="margin-top: 30px;padding-left:20%;padding-right: 20%">
            <label for="coverImg">封面:</label>
            <img id="coverImg" src="" style="width:60%;height: 60%;">
        </div>
...
<div id="chapter_dialog" class="easyui-dialog" title="添加章节" style="width:400px;height:500px;"
    ...
    <form id="chapter_ff" method="post" enctype="multipart/form-data">
        <input class="easyui-textbox" value="" name="album_id" id="album_id"  type="hidden"/>
        <div style="height: 40px;margin-top: 30px;padding-left: 20%;padding-right: 20%">
            <label for="album_title">所属专辑:</label>
            <input class="easyui-textbox" value="" name="album_title" id="album_title" style="visibility: hidden;width:100%;height: 100%" readonly/>
        </div>
        <div style="height: 40px;margin-top: 30px;padding-left: 20%;padding-right: 20%">
...
<%--双击播放--%>
<div id="album_paly" class="easyui-dialog" title="播放音频" style="width:400px;height:200px;background-color: #00bbee;text-align: center"
     data-options="iconCls:'icon-save',resizable:true,modal:true,closed:true">

    <div style="margin-top: 40px">
        歌曲名称：<span id="musicName" style="color:deeppink"></span>
    </div>

    <div style="margin-top: 20px">
        <audio id="audio" src="" controls="controls" autoplay="autoplay" style="text-align: center"></audio>
    </div>
...
<div id="album_addg" class="easyui-dialog" title="添加专辑" style="width:400px;height:650px;"
     data-options="iconCls:'icon-save',resizable:true,modal:true,closed:true,buttons:[{
				...
				handler:function(){
                    $('#album_add').form('submit', {
                     url:'${pageContext.request.contextPath}/album/saveAlbum',
                    success:function(data){
    ...
    <form id="album_add" method="post" enctype="multipart/form-data">
        ...
        <div style="height: 40px;margin-top: 30px;padding-left: 20%;padding-right: 20%">
            <input name="count" required="true" class="easyui-textbox" data-options="iconCls:'icon-man',prompt:'集数'" style="width:100%;height: 100%">
        </div>
        <div style="height: 40px;margin-top: 30px;padding-left: 20%;padding-right: 20%">
        ...
        <div style="height: 40px;margin-top: 30px;padding-left: 20%;padding-right: 20%">
            <input name="broadCaet" required="true" class="easyui-textbox" data-options="iconCls:'icon-man',prompt:'播音员'" style="width:100%;height: 100%">
        </div>
        <div style="height: 40px;margin-top: 30px;padding-left: 20%;padding-right: 20%">
        ...
        <div style="height: 40px;margin-bottom: 30px;margin-top: 10px;padding-left: 20%;padding-right: 20%">
            <input name="file" required="true"  class="easyui-filebox"  style="width:100%;height: 100%">
        </div>
    </form>
